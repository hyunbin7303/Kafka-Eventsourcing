...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class EditMessageController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> EditMessageAsync(Guid id, EditMessageCommand cmd)
        {
            try
            {
                cmd.Id = id;
                ...
                {
                    Message = "Edit msg request completed successfully."
                });
            }
            ...
            {
                const string SAFE_ERROR_MSG = "Error while processing request to edit the msg of a post!";
