...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class AddCommentController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> AddCommentAsync(Guid id, AddCommentCommand cmd)
        {
            try
            {
                cmd.Id = id;
                ...
                {
                    Message = "Add comment msg request completed successfully."
                });
            }
            ...
            {
                const string SAFE_ERROR_MSG = "Error while processing request to add a comment to a post!";
